...
class Preshoot(SerialHelp):
    ...
    def __init__(self, master, canvas):
        ...
        self.image = Image.open("./image/preshoot.bmp")
    ...
    def start(self):
        # 发送发送主机状态：进行预冲 aa bb cc dd 0f ff 08 60 20 00 00 00 00 00 00
        hostStatus = 'aa bb cc dd 0f ff 08 60 20 00 00 00 00 00 00'
        ...
        # 结束预冲
        self.butfinishpreshootimage = ImageTk.PhotoImage(Image.open("./image/but_finishpreshoot.bmp"))
        self.finishshootButton = ttk.Button(self.canvas, takefocus=False, image=self.butfinishpreshootimage,  command=self.finishpreshoot, cursor='none')  #
        self.finishshootButton.place(x=620, y=530)
    ...
    def finishpreshoot(self):
        print('Finish Preshoot...')
        self.finishshootButton.destroy()
